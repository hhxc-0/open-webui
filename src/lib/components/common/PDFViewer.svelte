...
<div class="relative {className}">
	...
	{#if !loading && !error && pdfDoc}
		...
		>
			...
			<button
				class="px-1.5 py-1 min-w-[3rem] text-center text-[0.6875rem] font-normal text-gray-500 dark:text-gray-400 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition tabular-nums"
				on:click={resetView}
