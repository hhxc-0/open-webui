...
{#if !$mobile && !$showSidebar}
	<div
		class=" w-[2.625rem] shrink-0 py-1 px-1 flex flex-col justify-between text-gray-700 dark:text-gray-300 hover:bg-gray-50/30 dark:hover:bg-gray-800/30 h-full z-10 transition-all border-e-[0.5px] border-gray-50 dark:border-gray-850/30"
		id="sidebar"
		role="navigation"
		...
		>
			<div class="pb-1">
				...
				>
					...
					>
						<div
							class=" self-center flex size-[1.875rem] items-center justify-center rounded-lg transition group-hover:bg-gray-50 dark:group-hover:bg-gray-900"
						>
							<img
					...
					{#if meta && isMenuItemVisible(itemId)}
						<div class="">
							<Tooltip content={$i18n.t(meta.label)} placement="right">
								...
								>
									<div
										class=" self-center flex size-[1.875rem] items-center justify-center rounded-lg transition {itemId ===
										activeMenuItemId
				...
				<div class=" flex justify-center items-center">
					{#if $user !== undefined && $user !== null}
						<UserMenu role={$user?.role} profile={$config?.features?.enable_user_status ?? true}>
							...
							>
								<div
									class="self-center relative flex size-[1.875rem] items-center justify-center rounded-lg transition group-hover:bg-gray-50 dark:group-hover:bg-gray-900"
								>
									<img
								...
								>
									...
									>
										...
										<div class="flex self-center translate-y-[0.5px]">
											<div class=" self-center text-[0.8125rem] leading-5">{$i18n.t(meta.label)}</div>
										</div>
									</a>
								</div>
							{/if}
